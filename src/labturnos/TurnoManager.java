...
public class TurnoManager {
    ...
    // Generación de IDs secuencias por prioridad
    ...
    public boolean siguienteGlobal() {
        ...
        // retiro cabina temporalmente (para evitar error al asignar)
        rankingLibres.remove(destino);
        Turno t = cola.poll();
        destino.asignar(t);
        // Al estar ocupada, NO se reingresar; volver cuando se libere
        return true;
    }
